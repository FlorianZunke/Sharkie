const level1 = new Level(
    ...
    [
        new Coin('img/4. Marcadores/1. Coins/3.png', 700, 300),
        new Coin('img/4. Marcadores/1. Coins/3.png', 1000, 300),
        new Coin('img/4. Marcadores/1. Coins/3.png', 700, 100),
        new Coin('img/4. Marcadores/1. Coins/3.png', 500, 300),
    ],
    [
        new Barriar('img/3. Background/Barrier/1.png', 500, -20, 500, 950),
        new Barriar('img/3. Background/Barrier/3.png', 1650, -50, 375, 300),
        new Barriar('img/3. Background/Barrier/2.png', 2250, 205, 275, 800),
    ]
